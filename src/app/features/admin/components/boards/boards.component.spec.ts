...
describe('BoardsComponent', () => {
  ...
  describe('#setSortValues', () => {
    it('should set expected values', () => {
      component.setSortValues({propertyName: 'description', order: 'desc'})
      fixture.detectChanges();
      expect(component.propertyName).toEqual('description');
      expect(component.ascOrder).toEqual('desc')
    })
  })
});
